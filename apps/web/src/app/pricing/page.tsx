...
export default function PricingPage() {
  ...
  const addons = [
    {
      name: "Additional AI Document Processing",
      price: "$99/month",
      description: "500 extra documents/month",
    },
    {
      name: "Advanced ESG Analytics",
      price: "$499/month",
      description: "Comprehensive sustainability tracking",
    },
    {
      name: "API Premium Tier",
      price: "$299/month",
      description: "Higher rate limits & priority",
    },
    {
        ...
        <div className="container mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Choose the plan that fits your needs. All plans include 14-day
